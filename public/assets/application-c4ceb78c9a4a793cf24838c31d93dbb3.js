...
(function() {
  ...
  window.deleteEvent = function(id) {
    return $.ajax({
      ...
      success: function(data, status, response) {
        if (data.error === true) {
          return $('#delete_events').removeClass('selected');
        } else {
          $('#' + id).remove();
  ...
  $(function() {
    $('select#event_country_code').change(function(event) {
    ...
    return $('select#locale').change(function(event) {
...
(function() {
  window.addToFavourites = function(user_id, favourite_user_id) {
    return $.ajax({
  ...
  window.removeFromFavourites = function(user_id, favourite_user_id) {
    return $.ajax({
...
(function() {
  window.app = {
    setup: function() {
      return $('a.delete_selected').click(function(ev) {
        ev.preventDefault();
        $('#messages tr').each(function(i, row) {
          var id;
          id = $(row).attr("id");
    ...
    deleteMessage: function(id) {
      return $.ajax({
        ...
        success: function(data, status, response) {
          if (data.error === true) {
            return $('a.delete_selected').removeClass('selected');
          } else {
            $('#' + id).remove();
            return window.location.reload();
          }
...
(function() {
  $(function() {
    $('select#profile_country_code').change(function(event) {
      var country_code, select_wrapper, url;
      select_wrapper = $('#state_code_wrapper');
      $('select', select_wrapper).attr('disabled', true);
      country_code = $(this).val();
